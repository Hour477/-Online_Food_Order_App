<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="scroll-smooth" x-data="{ sidebarOpen: false }">
<head>
    <meta charset="utf-8">
...
<body class="bg-gray-100 dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen antialiased">
    ...
    <div class="flex min-h-screen">
        ...
        <aside x-show="sidebarOpen || window.innerWidth >= 1024"
               ...
               class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-auto shadow-2xl"
        ...
        <div class="flex-1 flex flex-col min-h-screen">
            ...
            <header class="bg-white dark:bg-gray-800 shadow-sm sticky top-0 z-40">
                <div class="flex items-center justify-between px-4 py-3 lg:px-6">
                    ...
                    <!-- Mobile Hamburger -->
                    <button @click="sidebarOpen = !sidebarOpen" class="lg:hidden text-gray-500 dark:text-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 rounded-lg p-2">
                        <svg x-show="!sidebarOpen" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
