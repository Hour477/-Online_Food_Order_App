    ...
    <div
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage dishes, pricing, and availability</p>
            </div>
        ...
        <x-table.base-table>
            ...
            <x-slot name="head">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Rating</th>
                    <th scope="col" class="px-6 py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Price</th>
                    ...
                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/30 transition-colors">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center gap-1.5">
                                ...
                                <span class="text-sm font-bold text-gray-700 dark:text-gray-300">{{ number_format($item->rating, 1) }}</span>
