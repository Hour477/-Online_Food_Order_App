...
<div class="mx-auto">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700 overflow-hidden p-4 md:p-4">
        ...
        <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-10">
            <div>
                <h3 class="text-3xl font-bold text-gray-900 dark:text-white">Edit Menu Item</h3>
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Update details for &ldquo;{{ $menu_item->name }}&rdquo;</p>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="relative group w-32 h-32">
                        <img id="image-preview"
                             src="{{ $menu_item->image ? $menu_item->display_image : asset('assets/img/placeholder.png') }}"
                             alt="{{ $menu_item->name }}"
                    ...
                    <p class="mt-2 text-[10px] text-gray-500 dark:text-gray-400 italic">Recommended: Square image, max 2MB. Leave unchanged to keep the current photo.</p>
                    @error('image')
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="description" id="description" rows="5"
                              ...
                              class="block w-full px-5 py-4 text-base text-gray-900 dark:text-white placeholder-gray-400 bg-gray-50 dark:bg-gray-700/50 border border-gray-200 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent resize-y transition-all">{{ old('description', $menu_item->description) }}</textarea>
                    @error('description')
                        <p class="mt-1.5 text-xs text-red-500">{{ $message }}</p>
                    @enderror
                </div>
