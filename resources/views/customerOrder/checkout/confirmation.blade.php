...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
    ...
    <h1 class="text-4xl font-bold text-gray-900 mb-2">Order Placed!</h1>
    <p class="text-gray-500 mb-8">
        Thank you! Your order <span class="font-bold text-amber-600">#{{ $order->order_no }}</span> has been confirmed and is being prepared.
    </p>
    ...
    <div class="bg-amber-50 border border-amber-200 rounded-xl p-5 mb-8 flex items-center gap-4">
        ...
        <div class="text-left">
            <p class="text-xs text-gray-500 uppercase tracking-wide font-semibold">Estimated Delivery</p>
            <p class="text-2xl font-bold text-amber-600">30–45 minutes</p>
        </div>
    </div>

    {{-- Order Details --}}
    <div class="bg-white rounded-xl p-6 shadow-sm border border-gray-200 text-left mb-8">
        <h2 class="font-bold text-lg text-gray-900 mb-4">Order Details</h2>
        ...
        <div class="border-t border-gray-200 pt-4 space-y-1.5 text-sm">
            ...
            <div class="flex justify-between font-bold text-gray-900 text-base pt-1 border-t border-gray-200 mt-1">
                <span>Total</span><span class="text-amber-600">${{ number_format($order->total_amount, 2) }}</span>
            </div>
        </div>

        <div class="mt-4 pt-4 border-t border-gray-200 text-sm">
            <p class="text-xs text-gray-400 uppercase tracking-wide">Delivery Info</p>
